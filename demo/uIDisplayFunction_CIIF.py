...
#         #print("Please set the simulation speed(0:slow, 1:normal, 2:fast, 3: super fast):")
        ...
        descrip.create_text(335, 110, text="：Charger - Where AGVs' battery charged.",font=("arial", "15", "bold"))
        #Wall Descrip
        ...
        descrip.create_text(842, 70, text="：Charging Point", font=("arial", "15", "bold"))
        #AGV Descrip
